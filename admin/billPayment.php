            ...
            <div class="col-xs-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Nombre del Cliente: <?php echo $fname.' '.$mi.' '.$lname;?> | ID Cliente: <?php print $id;?></h3>
                ...
                <form role="form" action="billpaySave.php" method="POST">
				  ...
				  <input type="hidden" name="cnumber" value="<?php echo $id; ?>" />
                    <div class="form-group">
					   <label>Lectura anterior (ml)</label>
						<input class="form-control" name="prev" value="<?php echo $previous; ?>" placeholder="Lectura anterior" required readonly>
						<input type="hidden" class="form-control" name="cnumber" value="<?php echo $id;?>" required>
					  </div>
					  <div class="form-group">
					   <label>Lectura actual (ml)</label>
						<input class="form-control" name="pres" placeholder="Lectura actual" required>
					  </div>
					  <div class="form-group">
					   <label>Precio/ml</label>
						<input class="form-control" name="price" placeholder="Precio" required>
					  </div>
					   
                  </div><!-- /.box-body -->
                  <div class="box-footer">
                    <button type="submit" name="btnPay" class="btn btn-primary"><span class="fa fa-money"></span> Pagar</button>
                  </div>
                </form>
              </div><!-- /.box -->
